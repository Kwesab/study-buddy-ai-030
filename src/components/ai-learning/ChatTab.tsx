...
export default function ChatTab() {
  ...
  return (
    <Card className="flex-1 flex flex-col overflow-hidden border-border/50 h-full">
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-sm text-muted-foreground max-w-sm">Ask me anything about your lectures, concepts, or study strategies.</p>
          </div>
        )}
